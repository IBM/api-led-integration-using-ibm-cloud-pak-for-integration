...
[https://www.youtube.com/watch?v=TRzO26kawu4](https://www.youtube.com/watch?v=TRzO26kawu4)
...
4. [Building Your Integration](#4-building-your-integration)
6. [Testing our API Integration Flow](#5-testing-our-api-integration-flow)
7. [How we will test the APIs](#6-how-we-will-test-the-apis)
8. [Running the tests and results](#7-running-the-tests-and-results)
9. [Deploying the Integration flow to ICP4i RunTime via the App Connect Dashboard](#8-deploying-the-integration-flow-to-icp4i-runtime-via-the-app-connect-dashboard)
...
#### 2.1.1 IBM Cloud Pak for Integration

You will need to have an existing IBM Cloud Pak for Integration setup. For help with installation check this [link](https://www.ibm.com/in-en/cloud/cloud-pak-for-integration/get-started). Ensure to add App Connect and API Connect capabilities to your ICP4i instance.
...
#### 2.1.3 IBM Watson – Visual Recognition
...
#### 2.1.4 IBM Watson – Tone Analysis
...
#### 2.1.6 IBM Watson – Language Translation
...
You’ll next need to do similar for `Tone Analyzer` and  `Language Translator`. Both have free `Lite` plans and are set up in the same place on the IBM Cloud. You may choose any region you want.
...
<img src="./images/image-20200609223016557.png" alt="image-20200609223016557" width="40%" />               <img src="/Users/muralidhar/Murali/Work/Code Patterns/1CoreContent/23ICP4i/Repo/api-led-integration/Application Integration/images/image-20200702110423263.png" alt="image-20200702110423263" style="zoom:40%;" />
...
### 4.2 Accessing the Designer Integration Tooling
...
### 4.3 Connecting the tooling to our endpoints
...
### 4.4 Setting up the Salesforce Connection
...
### 4.5 Importing the Integration flow into designer
...
### 4.6 Reviewing our API Integration Flow:
...
### 6.4 Setting Environment Variables to test in the ACE Designer
...
### 7.1 Test 1: “Chicken Picture” – demotestchicken.sh
...
### 7.2 Test2: “Subaru SUV Picture” – demotestsubaru.sh
...
### 8.1 Exporting the executable bar file
...
### 8.2 Navigating to the App Connect dashboard and importing the .bar file
...
### 8.2.2 Which type of image to run
...
### 8.2.3 IBM App Connect Designer flows
...
## 8.3 Creating the Connector Credentials Secret
...
### 8.3.1 Downloading the Configuration Package
...
### 8.4 Testing the flow on the ICP4i runtime
